...
export async function GET(request, context) {
  ...
  const manifest = {
    ...
    icons: [
      ...
      // Android masks home-screen icons to a circle/squircle cut inside the
      // center 80% - these variants keep the calendar glyph inside that
      // safe zone so it isn't cropped or shown shrunken on a white plate.
